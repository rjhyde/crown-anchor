      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link href="/" className="text-white hover:text-amber-200 px-3 py-2 rounded-md text-sm font-medium">Beer List</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-amber-900">
            <Link href="/" className="text-white block px-3 py-2 rounded-md text-base font-medium">Beer List</Link>
